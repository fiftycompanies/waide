...
export async function getHomepageConfig(): Promise<HomepageConfig> {
  ...
  return {
    ...
    theme: {
      primary_color: materials?.primary_color || project?.theme_config?.primary_color || "#8B6914",
      secondary_color: materials?.secondary_color || project?.theme_config?.secondary_color || "#6B7B3A",
      font_heading: project?.theme_config?.font_heading || "Noto Serif KR",
      font_body: project?.theme_config?.font_body || "Noto Sans KR",
