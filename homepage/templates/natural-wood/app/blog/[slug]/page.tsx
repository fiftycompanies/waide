  ...
  return (
    <article className="pt-24 pb-16">
      ...
      <div className="container-narrow">
        <div className="mb-8">
          <span className={`inline-block px-3 py-1 rounded-2xl text-xs font-medium mb-4 ${
          ...
          <h1 className="text-3xl md:text-4xl font-bold leading-tight" style={{ fontFamily: "var(--font-heading)" }}>
            {post.title}
          </h1>
          {post.published_at && (
