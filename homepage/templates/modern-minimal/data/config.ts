...
export async function getHomepageConfig(): Promise<HomepageConfig> {
  ...
  return {
    ...
    theme: {
      primary_color: materials?.primary_color || project?.theme_config?.primary_color || "#2563eb",
      secondary_color: materials?.secondary_color || project?.theme_config?.secondary_color || "#10b981",
      font_heading: project?.theme_config?.font_heading || "Pretendard",
      font_body: project?.theme_config?.font_body || "Pretendard",
