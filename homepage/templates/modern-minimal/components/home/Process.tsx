    ...
    <section className="section-padding">
      <div className="container-wide" ref={ref}>
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold">시공 프로세스</h2>
          <p className="text-text-secondary mt-3">체계적인 5단계 프로세스로 완벽한 공간을 만듭니다</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          {STEPS.map((step, i) => (
            ...
            >
              ...
              <span className="absolute top-3 right-1/2 translate-x-1/2 text-6xl font-bold text-bg-muted -z-10">
                {i + 1}
              </span>
