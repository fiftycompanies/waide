    ...
    return (
      <section id="contact" className="section-padding bg-primary/5">
        <div className="container-narrow text-center">
          ...
          <h2 className="text-2xl font-bold mb-2">상담 신청이 완료되었습니다</h2>
    ...
    <section id="contact" className="section-padding bg-primary/5">
      <div className="container-narrow" ref={ref}>
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold">무료 상담 신청</h2>
        ...
        <motion.form
          ...
          className="max-w-lg mx-auto bg-white rounded-2xl p-8 border border-border-light shadow-sm"
        >
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full h-24 px-3 py-2 rounded-lg border border-border bg-bg text-sm resize-none"
