    ...
    startTransition(async () => {
      try {
        ...
        if (res.ok) {
          ...
          setError(data.error || "상담 신청에 실패했습니다. 다시 시도해주세요.");
        }
      } catch {
    ...
    return (
      <div className="pt-24 pb-16">
        <div className="container-narrow text-center py-20">
          ...
          <h1 className="text-3xl font-bold mb-3">상담 신청이 완료되었습니다</h1>
          <p className="text-text-secondary mb-8">
            담당자가 빠른 시일 내 연락드리겠습니다.<br />
            감사합니다.
          </p>
          <Link
            href="/"
    ...
    <div className="pt-24 pb-16">
      <div className="container-wide">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl md:text-4xl font-bold">상담 신청</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-2">
            <form
              ...
              className="bg-white rounded-2xl p-8 border border-border-light shadow-sm"
            >
              <h2 className="text-xl font-bold mb-6">상담 신청서</h2>
              ...
              <div className="space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full h-11 px-4 rounded-lg border border-border bg-bg text-sm focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary"
                      placeholder="홍길동"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full h-32 px-4 py-3 rounded-lg border border-border bg-bg text-sm resize-none focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary"
                    placeholder="궁금한 점이나 요청사항을 자유롭게 남겨주세요. (시공 시기, 희망 스타일, 특별 요청 등)"
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={isPending}
                  className="w-full h-12 rounded-lg bg-primary text-white font-medium hover:bg-primary-dark transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
                >
                  {isPending ? (
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl overflow-hidden border border-border-light shadow-sm">
              <div className="aspect-[4/3] bg-bg-muted flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-sm text-text-muted">지도</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-primary/5 rounded-2xl p-6">
              <h3 className="font-bold mb-2">상담 안내</h3>
